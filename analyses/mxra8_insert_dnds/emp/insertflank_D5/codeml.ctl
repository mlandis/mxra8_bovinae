      seqfile  = ../../data/Mxra8.bovinae.insert_flank.D5.fas             * sequence data filename
      outfile  = ../../output/Mxra8.bovinae.insert_flank.D5.out.txt * main result file name
      treefile = ../../data/Mxra8.bovinae.insert.D5.nrate2.tre
