      seqfile  = ../../data/Mxra8.bovinae.insert.test_D10.fas             * sequence data filename
      outfile  = ../../output/Mxra8.bovinae.insert.test_D10.out.txt * main result file name
      treefile = ../../data/Mxra8.bovinae.insert.test_D10.tre
