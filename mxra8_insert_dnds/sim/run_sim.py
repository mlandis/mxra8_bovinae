...
def write_ctl(tmpl_fn, idx=1):
    # make header str
    s = ''
    s += 'seqfile = ../data/sim/ns15/Mxra8.resample_' + str(idx) + '.fas\n'
    s += 'outfile = output/ns15/Mxra8.resample_' + str(idx) + '.out.txt\n'
...
def sim_one(idx=1):
    ...
    out_fn   = data_fp + 'sim/ns15/Mxra8.resample_' + str(idx) + '.fas'
    ctl_fn   = code_fp + 'sim/codeml.ctl'
    tmpl_fn  = code_fp + 'sim/codeml_template.ctl'
    rslt_fn  = code_fp + 'sim/output/ns15/Mxra8.resample_' + str(idx) + '.out.txt'
